...
public class MultipleArrayFormPars extends MultipleFormParsList {

    private MultipleFormParsList MultipleFormParsList;
    private Type Type;
    private String I3;

    public MultipleArrayFormPars (MultipleFormParsList MultipleFormParsList, Type Type, String I3) {
    ...
    public String toString(String tab) {
        ...
        buffer.append(tab);
        buffer.append("MultipleArrayFormPars(\n");
