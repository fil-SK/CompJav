...
public class MultipleNamespace extends NamespaceList {

    private NamespaceList NamespaceList;
    private Namespace Namespace;

    public MultipleNamespace (NamespaceList NamespaceList, Namespace Namespace) {
    ...
    public String toString(String tab) {
        ...
        buffer.append(tab);
        buffer.append("MultipleNamespace(\n");
