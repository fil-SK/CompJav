...
public class MultipleDesignatorExpansionArray extends MultipleDesignatorExpansion {

    private MultipleDesignatorExpansion MultipleDesignatorExpansion;
    private Expr Expr;

    public MultipleDesignatorExpansionArray (MultipleDesignatorExpansion MultipleDesignatorExpansion, Expr Expr) {
    ...
    public String toString(String tab) {
        ...
        buffer.append(tab);
        buffer.append("MultipleDesignatorExpansionArray(\n");
