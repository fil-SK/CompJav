...
public class MultipleAddop extends MultipleAddopTerms {

    private MultipleAddopTerms MultipleAddopTerms;
    private Addop Addop;
    private Term Term;

    public MultipleAddop (MultipleAddopTerms MultipleAddopTerms, Addop Addop, Term Term) {
