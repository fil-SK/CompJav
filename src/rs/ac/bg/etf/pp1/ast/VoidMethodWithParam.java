...
public class VoidMethodWithParam extends MethodDecl {
    ...
    public VoidMethodWithParam (MethodVoidName MethodVoidName, FormPars FormPars, VarDeclList VarDeclList, StatementList StatementList) {
    ...
    public String toString(String tab) {
        ...
        buffer.append(tab);
        buffer.append("VoidMethodWithParam(\n");
